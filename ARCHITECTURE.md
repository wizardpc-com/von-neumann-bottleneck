...
- Schema 2 adds visit/run/case identities, source classification and monotonic foreground/background/feedback checkpoints. Old schema 1 retains legacy uncertainty. `src/playtest/playtest_moments.gd` provides voluntary in-play feedback and export; `scripts/report-playtests.py` merges local exports with source separation, deduplication and incomplete visits. Neither is progression authority.
