...
> Runtime removed on 2026-09-09 by explicit user request. This document is historical; its scenes, autoload, exclusive tests and translations no longer ship. Existing player files are left untouched.
